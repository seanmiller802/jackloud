  ...
  <div class="container"><!--containter to hold the form and contact information-->
    ...
    <div class="row row3">
      <div class="col-xs-12 container">
        <div id="map">
          <iframe src="https://snazzymaps.com/embed/116653" width="100%" height="400px" scrolling="no" style="border:none;"></iframe>
        </div>
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCWpjJcurn5L4S4oCjhKW96yfMr97lsWtU&callback=initMap"></script>
      </div><!--end container-->
    </div><!--end row-->
  </div><!--end container-->
</section>
