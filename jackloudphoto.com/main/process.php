<?php
    ...
    if (empty($_POST['txtFirstName']))
        $errors['txtFirstName'] = 'required';

    if (empty($_POST['txtLastName']))
        $errors['txtLastName'] = 'required';

    if (empty($_POST['txtEmail']))
        $errors['txtEmail'] = 'required';

    if (empty($_POST['txtMessage']))
        $errors['txtMessage'] = 'required';
...
// return a response ===========================================
    ...
    if ( ! empty($errors)) {
        ...
        $data['success'] = true;
        $data['message'] = 'Thanks for the message!';
        ...
        $message2 = "Here is a copy of your form submission " .  "\n" . "<b>First name:</b> " . $_POST["txtFirstName"] . "\n" . "<b>Last name:</b> " . $_POST["txtLastName"] . "\n" . "<b>Email:</b> ". $_POST["txtEmail"] . "\n" . "<b>Messgage:</b> " . $_POST["txtMessage"];
